...
select json '[2,4,1,5,3]' @* '$[*] ? (!exists($[*] ? (@ > @1)))';
select json '[2,4,1,5,3]' @* 'strict $ ? (@[*] ? (@ < @1[1]) > 2)';
select json '[2,4,1,5,3]' @* 'strict $ ? (@[*] ? (@ < @1[1]) > 3)';
select json '[2,4,1,5,3]' @* 'strict $ ? (@[*] ? (@ ? (@ ? (@ < @3[1]) > @2[0]) > @1[0]) > 2)';
select json '[2,4,1,5,3]' @* 'strict $ ? (@[*] ? (@ ? (@ ? (@ < @3[2]) > @2[0]) > @1[0]) > 2)';
