...
DATA(insert OID = 6103 ( jsonpath_fcxt	PGNSP PGUID  4 t p P f t \054 0 0 0 jsonpath_fcxt_in jsonpath_fcxt_out - - - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define JSONPATH_FCXTOID	6103
